...
inline std::ios_base&
defaultfloat(std::ios_base& b) // to augment fixed and scientific as in C++11
{
...
// inline int randint(int min, int max) {  return
// uniform_int_distribution<>{min, max}(get_rand()); }
